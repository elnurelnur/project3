...
<script>
    ...
    function init() {
        ...
        var marker = new google.maps.Marker({
            position: new google.maps.LatLng(40.376099, 49.851578),
            map: map,
            icon: image,
